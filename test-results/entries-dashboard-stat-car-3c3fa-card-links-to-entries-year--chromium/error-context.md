...
- Name: entries.test.ts >> dashboard stat cards >> This Year card links to /entries?year=
- Location: tests/e2e/entries.test.ts:171:2
...
Call log:
  - waiting for getByRole('link', { name: /This Year/i })
