...
- Name: entries.test.ts >> entries page — URL filter params >> ?month=YYYY-MM shows filter label with month name
- Location: tests/e2e/entries.test.ts:62:2
...
Locator: getByText(/Filtered: April 2026/)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/Filtered: April 2026/)
