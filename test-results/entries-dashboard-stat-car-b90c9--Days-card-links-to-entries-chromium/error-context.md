...
- Name: entries.test.ts >> dashboard stat cards >> Total Days card links to /entries
- Location: tests/e2e/entries.test.ts:165:2
...
Locator: getByRole('link', { name: /Total Days/i })
Expected: "/entries"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('link', { name: /Total Days/i })
