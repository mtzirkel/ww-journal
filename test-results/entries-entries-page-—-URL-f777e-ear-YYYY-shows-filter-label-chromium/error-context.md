...
- Name: entries.test.ts >> entries page — URL filter params >> ?year=YYYY shows filter label
- Location: tests/e2e/entries.test.ts:57:2
...
Locator: getByText(/Filtered: 2026/)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/Filtered: 2026/)
