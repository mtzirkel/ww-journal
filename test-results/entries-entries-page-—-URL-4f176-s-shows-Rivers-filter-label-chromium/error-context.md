...
- Name: entries.test.ts >> entries page — URL filter params >> ?view=rivers shows Rivers filter label
- Location: tests/e2e/entries.test.ts:67:2
...
Locator: getByText(/Filtered: Rivers/)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/Filtered: Rivers/)
