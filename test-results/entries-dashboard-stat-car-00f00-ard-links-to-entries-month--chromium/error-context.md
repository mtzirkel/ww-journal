...
- Name: entries.test.ts >> dashboard stat cards >> This Month card links to /entries?month=
- Location: tests/e2e/entries.test.ts:178:2
...
Call log:
  - waiting for getByRole('link', { name: /This Month/i })
